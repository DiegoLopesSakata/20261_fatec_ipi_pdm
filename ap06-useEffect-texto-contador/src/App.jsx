...
const App = () => {
  ...
  useEffect(() => {
    console.log('Função de efeito colateral executou sem vetor de dependencia.')
    return () => {
  ...
  return (
    <div style={{padding: 20, borderColor: 'black', borderWidth: 1, borderStyle: 'solid', borderRadius: 8, textAlign: 'center'}}>
